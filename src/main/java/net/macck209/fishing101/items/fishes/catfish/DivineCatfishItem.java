...
public class DivineCatfishItem extends AutoFishItem {
    public DivineCatfishItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Divine Catfish").setStyle(Style.EMPTY.withColor(AutoFishItem.DIVINE));
    }
}
