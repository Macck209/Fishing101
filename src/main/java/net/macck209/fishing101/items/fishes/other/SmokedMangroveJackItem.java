...
public class SmokedMangroveJackItem extends AutoFishItem {
    public SmokedMangroveJackItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Smoked Mangrove Jack").setStyle(Style.EMPTY.withColor(MANGROVE));
    }
}
