...
public class LuminousShrimpItem extends AutoFishItem {
    public LuminousShrimpItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Luminous Shrimp").setStyle(Style.EMPTY.withColor(AutoFishItem.LUMINOUS));
    }
}
