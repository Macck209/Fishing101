...
public class SmokedLuminousShrimpItem extends AutoFishItem {
    public SmokedLuminousShrimpItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Smoked Luminous Shrimp").setStyle(Style.EMPTY.withColor(AutoFishItem.LUMINOUS));
    }
}
