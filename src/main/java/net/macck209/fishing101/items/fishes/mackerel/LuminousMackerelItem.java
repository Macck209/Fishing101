...
public class LuminousMackerelItem extends AutoFishItem {
    public LuminousMackerelItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Luminous Mackerel").setStyle(Style.EMPTY.withColor(LUMINOUS));
    }
}
