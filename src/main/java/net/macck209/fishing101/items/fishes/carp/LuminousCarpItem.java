...
public class LuminousCarpItem extends AutoFishItem {
    public LuminousCarpItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Luminous Carp").setStyle(Style.EMPTY.withColor(AutoFishItem.LUMINOUS));
    }
}
