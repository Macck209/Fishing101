...
public class SmokedCatfishItem extends AutoFishItem {
    public SmokedCatfishItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Smoked Catfish").setStyle(Style.EMPTY.withColor(ORDINARY));
    }
}
