...
public class OrdinaryCatfishItem extends AutoFishItem {
    public OrdinaryCatfishItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Catfish").setStyle(Style.EMPTY.withColor(ORDINARY));
    }
}
