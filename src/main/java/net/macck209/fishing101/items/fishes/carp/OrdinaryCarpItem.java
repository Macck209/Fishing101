...
public class OrdinaryCarpItem extends AutoFishItem {
    public OrdinaryCarpItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Carp").setStyle(Style.EMPTY.withColor(AutoFishItem.ORDINARY));
    }
}
