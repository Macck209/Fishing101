...
public class SmokedLuminousCarpItem extends AutoFishItem {
    public SmokedLuminousCarpItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Smoked Luminous Carp").setStyle(Style.EMPTY.withColor(AutoFishItem.LUMINOUS));
    }
}
