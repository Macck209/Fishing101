...
public class SmokedOrdinaryShrimpItem extends AutoFishItem {
    public SmokedOrdinaryShrimpItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Smoked Shrimp").setStyle(Style.EMPTY.withColor(AutoFishItem.ORDINARY));
    }
}
