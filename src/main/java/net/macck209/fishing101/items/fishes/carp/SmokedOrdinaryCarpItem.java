...
public class SmokedOrdinaryCarpItem extends AutoFishItem {
    public SmokedOrdinaryCarpItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Smoked Carp").setStyle(Style.EMPTY.withColor(AutoFishItem.ORDINARY));
    }
}
