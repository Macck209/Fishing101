...
public class MuddyCatfishItem extends AutoFishItem {
    public MuddyCatfishItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Muddy Catfish").setStyle(Style.EMPTY.withColor(MUDDY));
    }
}
