...
public class OrdinaryMackerelItem extends AutoFishItem {
    public OrdinaryMackerelItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Mackerel").setStyle(Style.EMPTY.withColor(ORDINARY));
    }
}
