...
public class MangroveJackItem extends AutoFishItem {
    public MangroveJackItem(Settings settings, Item polymerItem) {
    ...
    public Text getName(ItemStack stack) {
        return Text.translatable("Mangrove Jack").setStyle(Style.EMPTY.withColor(MANGROVE));
    }
}
