...
public class FishBookItem extends Item implements PolymerItem {
    ...
    private final String bookVariant;
    public FishBookItem(Item.Settings settings,String bookVariant) {
        super(settings);
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        if (stack.hasNbt()) {
            ...
            if(!bookVariant.equals("fish_book")){
                string = "Johnny Gourmet";
            }
    ...
    public static void build(String bookVariant){
